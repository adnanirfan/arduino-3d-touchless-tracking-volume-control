...
//  c = new Client(this, "127.0.0.1", 3000); 
  getmax = new GetRequest("http://localhost:3000/max");   
  getmid = new GetRequest("http://localhost:3000/mid");   
  getmin = new GetRequest("http://localhost:3000/min");   
  reset();
}
